...
void 
kiran_tray_manager_emit_icon_added (KiranTrayManager *manager,
...
void 
kiran_tray_manager_emit_icon_removed (KiranTrayManager *manager,
				      KiranNotifyIcon *icon)
{
...
void 
kiran_tray_manager_set_icon_size (KiranTrayManager *manager,
				  gint icon_size)
{
