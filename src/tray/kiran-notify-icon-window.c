                                      ...
                                      GObjectConstructParam *construct_properties)
{
    ...
    obj = G_OBJECT_CLASS (kiran_notify_icon_window_parent_class)->constructor (type,
...
void       
kiran_notify_icon_window_add_icon (KiranNotifyIconWindow *window,
...
void       
kiran_notify_icon_window_remove_icon (KiranNotifyIconWindow *window,
				      KiranNotifyIcon *icon)
{
    KiranNotifyIconWindowPrivate *priv = window->priv;
    gint row;
...
gint       
kiran_notify_icon_window_get_icons_number (KiranNotifyIconWindow *window)
{
    KiranNotifyIconWindowPrivate *priv = window->priv;
