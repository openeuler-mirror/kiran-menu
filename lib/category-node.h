 ...
 * @LastEditTime : 2020-06-03 17:08:09
 * @Description  : 
...
class CategoryNode : public std::enable_shared_from_this<CategoryNode>
{
   public:
    ...
    std::shared_ptr<CategoryNode> get_next() { return this->next; }
    std::shared_ptr<CategoryNode> get_children() { return this->children; }
    std::shared_ptr<CategoryNode> get_parent() { return this->parent.lock(); }
    const std::string& get_content() { return this->content; }
    void set_content(const std::string& content) { this->content = content; }
    CategoryNodeType get_type() { return this->type; }
   ...
   private:
    std::weak_ptr<CategoryNode> prev;
    std::shared_ptr<CategoryNode> next;
    std::weak_ptr<CategoryNode> parent;
    std::shared_ptr<CategoryNode> children;
    std::weak_ptr<CategoryNode> last;
